...
| 0.6 | Doc sync — PLAN.md (librosa refs done in 0.1; new endpoints pending 0.4), README (ffmpeg optional done; endpoints/config pending). | `PLAN.md`, `README.md` | partial |
